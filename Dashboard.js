    ...
    return (
        <section className="dashboard-section">
            ...
            <div className="moving-images" style={{ display: 'flex', gap: '10px', marginTop: '20px' }}>
                <img src="Tea.jpg" alt="Moving Image 1" width="80" height="80" />
                <img src="meat.jpg" alt="Moving Image 2" width="80" height="80" />
                <img src="bread.jpg" alt="Moving Image 3" width="80" height="80" />
            </div>
